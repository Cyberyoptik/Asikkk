export default function Footer() {
    return (
        <footer className="p-4 bg-primary-900 sm:p-6 dark:bg-gray-800">
            <div className="mx-auto max-w-screen-xl mt-5 mb-5">
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-50 sm:text-center dark:text-gray-400">Copyright © 2019 - 2023 Gemar Kode Community
                    </span>
                    <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        <a href="https://facebook.com/gemarkode" target="_blank" className="text-gray-50 hover:text-gray-900 dark:hover:text-white">
                        ...
                        <a href="https://instagram.com/gemarkode" target="_blank" className="text-gray-50 hover:text-gray-900 dark:hover:text-white">
                        ...
                        <a href="https://github.com/gemarkode" target="_blank" className="text-gray-50 hover:text-gray-900 dark:hover:text-white">
